 ...
 * @author sh
 */
public class TrialCancelDialog extends Dialog {
    ...
    public TrialCancelDialog(Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.dialog_trial_cancel);
    ...
    private void tryGiveup() {
        ...
        TrialReq.tryGiveup(mContext, data, new Listener<RespData>() {
