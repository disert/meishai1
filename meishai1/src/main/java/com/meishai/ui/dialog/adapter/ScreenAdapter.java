package com.meishai.ui.dialog.adapter;
...
public class ScreenAdapter extends
    ...
    public ScreenAdapter(Context context, List<ImageData> datats) {
        mInflater = LayoutInflater.from(context);
        mDatas = datats;
        mImageLoader = VolleyHelper.getImageLoader(context);
    }

    public ScreenAdapter(Context context, List<ImageData> datats, int itemResid) {
        mInflater = LayoutInflater.from(context);
        mDatas = datats;
        mImageLoader = VolleyHelper.getImageLoader(context);
