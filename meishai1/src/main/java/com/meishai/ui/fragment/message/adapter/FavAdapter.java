...
import com.meishai.entiy.MessageFavRespBean;
...
public class FavAdapter extends MeiwuAdapter {
    private MessageFavRespBean mData;
    private Context mContext;
    private ImageLoader mImageLoader;
    public FavAdapter(Activity context, ImageLoader imageLoader){
    ...
    protected void initData(String data) {
        try {
            ...
            if(jsonObject.getInt("success") == 1){
                MessageFavRespBean bean = GsonHelper.parseObject(data, MessageFavRespBean.class);
                if(bean != null){
    ...
    public String getTitle() {
        return mContext.getString(R.string.new_collect);
    }
    @Override
    public int getCount() {
