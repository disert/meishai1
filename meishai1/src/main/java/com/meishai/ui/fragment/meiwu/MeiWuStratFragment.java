...
import com.meishai.ui.fragment.meiwu.adapter.MeiWuStratAdapter;
 ...
 * @author yl
 */
public class MeiWuStratFragment extends BaseFragment {
    private int currentPage = 1;
    private View view;
    private PullToRefreshListView mListView;
    private MeiWuStratAdapter mAdapter;
    private StrategyResqData mData;
    private final String cacheKey = "MeiWuStratFragment";
    ...
    private void initView() {
        ...
        // 写适配器
        mAdapter = new MeiWuStratAdapter(getActivity(), getImageLoader());
...
//			showProgress("", getString(R.string.network_wait));
            ...
            MeiWuReq.strategyReq(page, new Listener<String>() {

                @Override
                public void onResponse(String response) {
//					DebugLog.w("攻略数据:"+response);
                    //缓存数据
