 ...
 * 我的-我的消息
 *
 * @ClassName: UserMsgActivity
 */
public class UserMsgActivity extends BaseActivity implements OnClickListener {

    private Context mContext = UserMsgActivity.this;
    ...
    private void loadData() {
        ...
        data.put(ConstantSet.USERID, MeiShaiSP.getInstance().getUserInfo()
                .getUserID());
        data.put("tableid", MsgTableId.MSG.getType());
