...
import com.meishai.ui.fragment.meiwu.adapter.ShopsAdapter;
...
/**
 * 美物 - 品质好店 2015年12月4日14:06:30 新增
 *
 * @author yl
 */
public class MeiWuShopsFragment extends BaseFragment {
    private int currentPage = 1;
    private View view;
    private PullToRefreshListView mListView;
    private ShopsAdapter mAdapter;
    private SpecialListRespData mData;
    private String cacheKey = "MeiWuShopsFragment";
    ...
    private void initView() {
        ...
        // 写适配器
        mAdapter = new ShopsAdapter(getActivity(), getImageLoader());
...
//		showProgress("", getString(R.string.network_wait));
        MeiWuReq.goodShops(page, new Listener<String>() {
