...
/**
 * @ClassName: TrialingFragment
 * @Description: 我的试用->进行中
 */
public class UserTrialingFragment extends BaseFragment implements
        OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mNoIngView = inflater.inflate(R.layout.user_trial_ing, null);
        currentPage = 1;
    ...
    private void initView() {
        mListview = (RefreshListView) mNoIngView.findViewById(R.id.listview);
    ...
    private void notifyTrialAdapter() {
        if (null == tiralAdapter) {
            tiralAdapter = new TrialAdapter(mContext, TrialInfo.TRIAL_ING, trialInfos);
    ...
    public void loadData() {
        ...
        data.put("status", TrialInfo.TRIAL_ING);
