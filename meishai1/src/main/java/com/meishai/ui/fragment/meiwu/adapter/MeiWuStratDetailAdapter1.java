 ...
 */
public class MeiWuStratDetailAdapter1 extends BaseAdapter {
    ...
    public MeiWuStratDetailAdapter1(Context context, ImageLoader imageLoader) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (TYPE_HEADER == type) {// 头
            ...
            // item
            if (convertView == null) {
                convertView = new MeiWuStratDetailItemLayout1(mContext);
            }
            ((MeiWuStratDetailItemLayout1) convertView).setData(
