 ...
 * 我的-我的私信
 *
 * @ClassName: UserPriMsgActivity
 */
public class UserPriMsgActivity extends BaseActivity implements OnClickListener {

    private Context mContext = UserPriMsgActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_pri_msg);
        currentPage = 1;
    ...
    private void loadData() {
        ...
        data.put(ConstantSet.USERID, MeiShaiSP.getInstance().getUserInfo()
                .getUserID());
        data.put("tableid", MsgTableId.PRI_LETTER.getType());
