...
import com.meishai.ui.fragment.tryuse.adapter.TasteAdapter;
...
public class TasteFragment extends BaseFragment {
    ...
    private FreeTrialRespData mData;
    ...
    private void initView() {
        ...
        // 写适配器
        mAdapter = new TasteAdapter(mContext, getImageLoader());
    ...
    private void getRequestData(int page) {
        ...
        FuLiSheReq.taste(page, new Listener<String>() {
    ...
    protected void checkRespData(String response) {
        try {
            ...
            if (success == 1) {
                FreeTrialRespData resqData = GsonHelper.parseObject(response,
                        FreeTrialRespData.class);
                if (resqData.page == 1) {
                    mData = resqData;
