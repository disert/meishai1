 ...
 * 版    权：
 */
public class ReleaseProgress1 extends Dialog {
     ...
     * @param theme   主题
     */
    public ReleaseProgress1(Context context, int theme) {
        super(context, theme);
    }
     ...
     * @param context 上下文对象
     */
    public ReleaseProgress1(Context context) {
        super(context);
    }
    ...
    public static class Builder {
         ...
         *
         * @param positiveButtonText 按钮字符串资源id
         * @param listener           按钮监听
         * @return Builder对象
         */
         ...
         *
         * @param positiveButtonText 按钮字符串资源
         * @param listener           按钮监听
         * @return Builder对象
         */
         ...
         */
        public void setSubMessageTextColor(int textColor) {
            this.mSubMessageTextColor = textColor;
        }
        ...
        public int getSubMessageTextSize() {
            return mSubMessageTextSize;
        }

        /**
         * 设置副消息文本字体大小
         *
         * @param textSize 副消息文本字体大小
         */
        public void setSubMessageTextSize(int textSize) {
            this.mSubMessageTextSize = textSize;
        }
         ...
         *
         * @param negativeButtonText 按钮字符串资源id
         * @param listener           按钮监听
         * @return Builder对象
         */
         ...
         *
         * @param negativeButtonText 按钮字符串资源
         * @param listener           按钮监听
         * @return Builder对象
         */
         ...
         */
        public ReleaseProgress1 create(int id) {
            final ReleaseProgress1 dialog = new ReleaseProgress1(mContext, 0 == mTheme ? R.style.Dialog : mTheme);
         ...
         */
        private void setDialogNegativeBtn(final int id, final ReleaseProgress1 dialog, Button negativeButton) {
         ...
         */
        private void setDialogPositiveBtn(final int id, final ReleaseProgress1 dialog, Button positiveButton) {
         ...
         * @param tvMessage 对话框Message对象
         */
        private void setDialogSubMessage(TextView tvMessage) {
