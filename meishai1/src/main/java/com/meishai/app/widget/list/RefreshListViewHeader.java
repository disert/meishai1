...
public class RefreshListViewHeader extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        // 时间TextView
        mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.widget_refreshlist_header, null);
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                if (StringUtils.isNotBlank(hintText)) {
                    ...
                    mHintTextView.setText(R.string.refreshlist_refresh_pull_label);// 文字提示：下拉刷新
                }
            ...
            case STATE_READY:
                if (mState != STATE_READY) {
                    ...
                    if (StringUtils.isNotBlank(hintText)) {
                        ...
                        mHintTextView.setText(R.string.refreshlist_header_hint_ready);// 松开刷新数据
                    }
                }
                break;
            case STATE_REFRESHING:
                if (StringUtils.isNotBlank(hintText)) {
                    ...
                    mHintTextView.setText(R.string.refreshlist_header_hint_loading);
                }
                break;
            default:
        }
