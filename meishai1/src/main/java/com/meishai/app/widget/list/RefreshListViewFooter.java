...
public class RefreshListViewFooter extends LinearLayout {
    ...
    public void setState(int state) {
        ...
        if (state == STATE_READY) {        // 如果是第一页状态，那么“查看更多”显示
            ...
            if (StringUtils.isNotBlank(hintText)) {
                ...
                mHintView.setText(R.string.refreshlist_footer_hint_ready);    // 松开显示更多
            }
            ...
            if (StringUtils.isNotBlank(hintText)) {
                ...
                mHintView.setText(R.string.refreshlist_footer_hint_normal);    // 查看更多
            }
        }
    }
    ...
    private void initView(Context context) {
        mContext = context;
        LinearLayout moreView = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.widget_refreshlist_footer, null);
        addView(moreView);
