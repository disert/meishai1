...
public class IFEarlybirdFilter extends InstaFilter {
    ...
    public IFEarlybirdFilter(Context context) {
        super(SHADER, 5);
        bitmaps[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.early_bird_curves);
        bitmaps[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.earlybird_overlay_map);
        bitmaps[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.vignette_map);
        bitmaps[3] = BitmapFactory.decodeResource(context.getResources(), R.drawable.earlybird_blowout);
        bitmaps[4] = BitmapFactory.decodeResource(context.getResources(), R.drawable.earlybird_map);
    }
