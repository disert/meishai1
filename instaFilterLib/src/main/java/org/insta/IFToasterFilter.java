...
public class IFToasterFilter extends InstaFilter {
    ...
    public IFToasterFilter(Context context) {
        super(SHADER, 5);
        bitmaps[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.toaster_metal);
        bitmaps[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.toaster_soft_light);
        bitmaps[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.toaster_curves);
        bitmaps[3] = BitmapFactory.decodeResource(context.getResources(), R.drawable.toaster_overlay_map_warm);
        bitmaps[4] = BitmapFactory.decodeResource(context.getResources(), R.drawable.toaster_color_shift);
    }
