...
public class IFXproIIFilter extends InstaFilter {
    ...
    public IFXproIIFilter(Context context) {
        super(SHADER, 2);
        bitmaps[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.xpro_map);
